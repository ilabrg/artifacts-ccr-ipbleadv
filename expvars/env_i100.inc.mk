...
CFLAGS += -DNIMBLE_RPBLE_CONN_ITVL_MIN_MS=100
CFLAGS += -DNIMBLE_RPBLE_CONN_ITVL_MAX_MS=100
CFLAGS += -DNIMBLE_RPBLE_CONN_LATENCY=0
CFLAGS += -DNIMBLE_RPBLE_CONN_SUPER_TO_MS=1500

CFLAGS += -DNIMBLE_AUTOCONN_CONN_ITVL_MIN_MS=100
CFLAGS += -DNIMBLE_AUTOCONN_CONN_ITVL_MAX_MS=100
CFLAGS += -DNIMBLE_AUTOCONN_CONN_LATENCY=0
CFLAGS += -DNIMBLE_AUTOCONN_CONN_SVTO_MS=1500

CFLAGS += -DNIMBLE_STATCONN_CONN_ITVL_MIN_MS=100
