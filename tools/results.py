...
class Results(Ana):
    ...
    def plotme(self):
        ...
        self.llstats.plot_jelling_pkt_ratio()
        # self.llstats.plot_jelling_pkt_ratio(nodes=["nrf52dk-6"], timespan=[0, 3600])
        # self.llstats.plot_jelling_pkt_ratio(nodes=["nrf52840dk-10"], timespan=[0, 3600])
        self.llstats.plot_jelling_adv_pkt_cnt()
        self.llstats.plot_jelling_adv_pkt_cnt(nodes=["nrf52dk-6"])#, timespan=[0, 3600])
        self.llstats.plot_jelling_adv_pkt_cnt(nodes=["nrf52840dk-10"])#, timespan=[0, 3600])
        ...
        self.llstats.plot_phy_usage_sum(nodes=["nrf52dk-6"], timespan=[0, 3600])
        self.llstats.plot_phy_usage_sum(nodes=["nrf52840dk-10"], timespan=[0, 3600])
