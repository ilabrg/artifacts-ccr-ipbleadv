...
class Fig(Expbase):
    ...
    def make(self):
        ...
        ax[0].boxplot([self.boxes[name]["tx"] for name in dat0], whis=[0, 100])
        ax[1].boxplot([self.boxes[name]["tx"] for name in dat1], whis=[0, 100])
        ...
        fig.text(0.20, 0.295, 'IP-BLE-Adv', ha='center', va='center', size=TICKLBLSIZE)
        fig.text(0.42, 0.628, '6BLEMesh', ha='center', va='center', size=TICKLBLSIZE)
        fig.text(0.66, 0.628, 'IP-BLE-Adv', ha='center', va='center', size=TICKLBLSIZE)
        fig.text(0.87, 0.628, '6BLEMesh', ha='center', va='center', size=TICKLBLSIZE)
